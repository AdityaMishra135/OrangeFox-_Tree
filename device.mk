...
OF_USE_LEGACY_BATTERY_SERVICES := 0
OF_SKIP_DECRYPTED_ADOPTED_STORAGE := 0
OF_ENABLE_FS_COMPRESSION := 0
OF_FORCE_PREBUILT_KERNEL := 1
OF_USE_DMCTL := 0
OF_USE_AIDL_BOOT_CONTROL := 0
OF_NO_KEYMASTER_VER_4X := 0
OF_WIPE_METADATA_AFTER_DATAFORMAT := 0
OF_BIND_MOUNT_SDCARD_ON_FORMAT := 0
OF_UNMOUNT_SDCARDS_BEFORE_REBOOT := 1
OF_MANUAL_ROOT_VENDOR_ERROR_FIX := 0
OF_LOOP_DEVICE_ERRORS_TO_LOG := 0
OF_FORCE_CASEFOLDING := 0
OF_SKIP_PREBUILT_MODULES := 0
OF_FORCE_DATA_FORMAT_F2FS := 0
OF_FORCE_DATA_FORMAT_EXT4 := 0
OF_DYNAMIC_FULL_SIZE :=
OF_NO_REFLASH_CURRENT_ORANGEFOX := 0
OF_FORCE_USE_RECOVERY_FSTAB := 0
OF_DEFAULT_KEYMASTER_VERSION :=
OF_NO_ADDITIONAL_MIUI_PROPS_CHECK := 0
OF_DISPLAY_FORMAT_FILESYSTEMS_DEBUG_INFO := 0
OF_USE_LOCKSCREEN_BUTTON := 0
OF_OPTIONS_LIST_NUM := 4
OF_SUPPORT_OZIP_DECRYPTION := 0
OF_PATCH_AVB20 := 0
OF_SUPPORT_VBMETA_AVB2_PATCHING := 0
OF_SKIP_ORANGEFOX_PROCESS := 0
OF_DONT_PATCH_ON_FRESH_INSTALLATION := 0
OF_NO_MIUI_OTA_VENDOR_BACKUP := 0
